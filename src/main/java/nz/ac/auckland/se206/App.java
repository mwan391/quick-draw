...
public class App extends Application {
	...
	/**
	 * Returns the node associated to the input file and its controller to the
	 * designated hashmap. The method expects that the file is located in
	...
	/**
	 * This method is invoked when the application starts. It loads all of the
	 * scenes, and shows the "Menu" scene.
	 *
